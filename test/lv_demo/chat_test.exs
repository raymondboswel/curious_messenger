defmodule LvDemo.ChatTest do
  use LvDemo.DataCase

  alias LvDemo.Chat

  describe "chat_conversations" do
    alias LvDemo.Chat.Conversation
  ...
  describe "chat_conversation_members" do
    alias LvDemo.Chat.ConversationMember
  ...
  describe "chat_message_reactions" do
    alias LvDemo.Chat.MessageReaction
